...
<head>
    ...
    <link href="../assets_user/global/css/plugins.min.css" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="../assets_user/pages/css/profile.min.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <section id="container" class="">
        ...
        <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">HIDRO <span class="lite">CAMPO</span></a>
            <!--logo end-->
    ...
    <script src="../assets_user/pages/scripts/ui-modals.min.js" type="text/javascript"></script>
    <!-- gritter -->
